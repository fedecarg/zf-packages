...
class Zf_Controller_Action_Helper_Layout
{
    ...
    {
        if (property_exists($this->getPlaceholder(), $property)) {
            return $this->getPlaceholder()->$property;
        }
        throw new Zf_Controller_Action_Exception('Undefined property: ' . $property);
    }
    ...
    {
        $this->getPlaceholder()->$property = $value;
    }
