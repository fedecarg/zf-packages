...
/**
 * Zf_Controller_Request_Http
 *
 * HTTP request object for use with Zf_Controller family.
 *
 * @uses Zf_Controller_Request_Abstract
 * @package Zf_Controller
 * @subpackage Request
 */
class Zf_Controller_Request_Http extends Zf_Controller_Request_Abstract
{
    /**
     * Scheme for http
     *
     ...
     * @param mixed $value
     * @return void
     * @throws Zf_Controller_Request_Exception
     */
    public function __set($key, $value)
    {
        throw new Zf_Controller_Request_Exception('Setting values in superglobals not allowed; please use setParam()');
    }
     ...
     * @return Zf_Controller_Request_Http
     */
    public function setQuery($spec, $value = null)
    {
        if ((null === $value) && !is_array($spec)) {
            throw new Zf_Controller_Exception('Invalid value passed to setQuery(); must be either array of values or key/value pair');
        }
        if ((null === $value) && is_array($spec)) {
    ...
    {
        if ((null === $value) && !is_array($spec)) {
            throw new Zf_Controller_Exception('Invalid value passed to setPost(); must be either array of values or key/value pair');
        }
        if ((null === $value) && is_array($spec)) {
            foreach ($spec as $key => $value) {
    ...
    public function getHeader($header)
    {
        if (empty($header)) {
            ...
            throw new Zf_Controller_Request_Exception('An HTTP header name is required');
        }
